...
| Powerline Agent | [`Powerline-Agent/`](Powerline-Agent/) | LLM agent with tools for battery historical vs perfect-foresight gap analysis and trading recommendations. |
